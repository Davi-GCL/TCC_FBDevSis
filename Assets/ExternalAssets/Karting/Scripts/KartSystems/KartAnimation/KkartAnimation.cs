...
namespace KartGame.KartSystems
{
    ...
    public class KkartAnimation : MonoBehaviour
    {
        ...
        [Serializable] public class KartAxis
        {
        ...
        [Tooltip("Information referring to the Aaxis")]
        public Wheel Aaxis;
        ...
        void FixedUpdate() 
        {
            ...
            Aaxis.wheelCollider.steerAngle = rotationAngle;
